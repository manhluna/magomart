...
var connectDB = ()=>{
    ...
    return mongoose.connect('mongodb+srv://luna:Liecoin1@magomart-y5a4q.mongodb.net/Ecommercial?retryWrites=true', { useUnifiedTopology: true,useNewUrlParser: true, useFindAndModify: false, useCreateIndex: true });
};
